...
def dynamic_opt(budget_list,budget_index,rewards_per_subcampaign, return_mode=1):
    ...
    for i in range(1,nrows):
        for j in range(ncols):
            ...
            for k in range(j+1):
                ...
                temp = rewards_per_subcampaign[i-1][j-k] + table[i-1][k] # inversely cycle through vecs to get partial results
